    ...
    return (
        <section>
            <div className="content">
                <h2>Banner ache ekhane</h2>
                <p> habi jabi habi jabi habi jabi habi jabihabi jabihabi jabihabi jabihabi jabi habi jabihabi jabihabi jabihabi jabihabi jabihabi jabi habi jabihabi jabihabi jabihabi jabi habi jabihabi jabihabi jabihabi jabihabi jabi</p>
            </div>
